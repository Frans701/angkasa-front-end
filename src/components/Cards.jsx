...
function Cards() {
  ...
  return (
    <>
      <div className="flex flex-col items-start gap-[16px] px-[40px] py-[24px] rounded-lg drop-shadow-lg bg-white">
        ...
        <div className="w-full">
          {details == "detailPenerbangan" ? (
            <div className="w-full border-t-2 pt-[16px] flex-col flex">
              <div className="flex flex-row gap-[40px]">
                <div className="flex flex-col py-[16px]">
                  <span className="w-[80px] text-lg font-semibold"> 11:15</span>
                  <span className="text-gray-500">05 Dec </span>
                </div>
                <div className="border-l-2"></div>
                <div className="flex flex-col py-[16px]">
                  <span className="font-semibold text-lg"> Jakarta (CGK)</span>
              ...
              <div className="flex flex-row gap-[40px]">
                <div className="flex flex-col py-[16px]">
                  <span className="w-[80px] text-lg font-semibold"> 14:05</span>
                  <span className="text-gray-500">05 Dec</span>
                </div>
                <div className="border-l-2"></div>
                <div className="flex flex-col py-[16px]">
          ...
          {details == "detailHarga" ? (
            <div className="w-full border-t-2 pt-[16px] flex-col flex gap-[16px]">
              ...
              <div className="flex flex-row justify-between pt-[16px] border-t-2">
                <h5 className="font-medium xl:text-xl">Total Pembayaran</h5>
