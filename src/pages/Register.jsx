              ...
              <form className='max-w-[425px] w-full mx-auto bg-white p-4'
                        onSubmit={handleSubmit}>
                            ...
                            <label className="flex flex-col py-2">
                                <span className="block text-base font-medium  text-slate-700">Nama Lengkap</span>
                                <input
                                type="text"
                                id="fullname"
                            ...
                            {/*CONFIRM PASSWORD*/}
                            <label className="flex flex-col py-2">
                                <span className="block text-base font-medium  text-slate-700">Konfirmasi Password</span>
                                <input
                                type="password"
                            ...
                            <button className="border w-full my-2 py-2 bg-yellow-300 text-blue-600 font-bold">Buat Akun</button>
                            <p className='flex flex-col items-center text-sm mb-3'>Sudah memiliki akun?</p>
                        </form>
            </section>
          )}
      </div>
